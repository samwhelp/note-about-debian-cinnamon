...
> 概覽 / [工作流程](https://samwhelp.github.io/note-about-debian-cinnamon/read/guide/workflow)

> [鍵盤按鍵綁定說明](https://samwhelp.github.io/note-about-debian-cinnamon/read/config/keybind.html)

> 如何 / [設定「按鍵綁定」](https://samwhelp.github.io/note-about-debian-cinnamon/read/howto/config-keybind.html)
...
| 按鍵組合     | 功能                                 | 設定項目                                                |
| ----------- | ----------------------------------- | ----------------------------------------------------- |
| `Alt + F1`  | `開啟「應用程式啟動主選單(Main Menu)」`  | 請參考『[停用按鍵綁定「Super_L」開啟「Main Menu」](https://samwhelp.github.io/note-about-debian-cinnamon/read/howto/disable-keybind-open-main-menu.html)』 |
...
| 相關連結 |
| ------- |
| [鍵盤按鍵綁定](https://samwhelp.github.io/note-about-debian-cinnamon/read/config/keybind.html) |
